...
const GroupPackageOne = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      area: "Day 1",
      tagline: "",
      img: "/img/group-packages-goa/group-package-one/Three Star Hotel.jpg",
      description: (<>
        <div class="">
    ...
    },
    {
      ...
      img: "/img/group-packages-goa/group-package-one/South Goa.jpeg",
      description: (<>
    ...
    },
    {
      ...
      img: "/img/group-packages-goa/group-package-one/North Goa.jpg",
      description: (<>
        <ul class=" text-gray-700 space-y-2">
          <li>{"1. Fort Aguada"}</li>
    ...
    },
    {
      ...
      area: "Day 4",
      tagline: "",
      img: "/img/group-packages-goa/group-package-one/Checkout.jpg",
      description: (<>
        <ul class=" text-gray-700 space-y-2">
  ...
  const SLIDES = [
    "/img/group-packages-goa/group-package-one/carousel/1.jpg",
    "/img/group-packages-goa/group-package-one/carousel/2.jpeg",
    "/img/group-packages-goa/group-package-one/carousel/3.jpg",
    "/img/group-packages-goa/group-package-one/carousel/4.jpg",
    "/img/group-packages-goa/group-package-one/carousel/5.jpg",
  ]
  ...
  const initialFxn = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/category?maincategory=${"Group Packages"}&subcategory=${"Group Package - 1"}`,
        {
          method: "GET",
          headers: {
  ...
  const imgSection = "/img/group-packages-goa/group-package-one/group section.jpg"
  ...
  return (
    <>
      <TourCombo data={data} title={"Group Goa Package - 1"} titleImg={`/img/group-packages-goa/group-package-one/group-package-one.jpg`} SLIDES={SLIDES} OPTIONS={OPTIONS} bookingSection={bookingSection} description={description} destination={destination} inclusions={inclusions} imgSection={imgSection} action={action} off={off} />
    </>
  );
};

export default GroupPackageOne;
