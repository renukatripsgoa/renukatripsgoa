...
const CouplePackageThree = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      img: "/img/couple-packages-goa/couple-package-three/North Goa.jpeg",
      description: (<>
  ...
  const initialFxn = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/category?maincategory=${"Couple Packages"}&subcategory=${"Couple Package - 3"}`,
        {
          method: "GET",
          headers: {
  ...
  const imgSection = "/img/couple-packages-goa/couple-package-three/couple.jpeg"
  ...
  return (
    <>
      <TourCombo data={data} title={"Couple Package - 3"} titleImg={`/img/couple-packages-goa/couple-package-three/couple-package-three.jpg`} SLIDES={SLIDES} OPTIONS={OPTIONS} bookingSection={bookingSection} description={description} destination={destination} inclusions={inclusions} imgSection={imgSection} action={action} off={off}/>
    </>
  );
};

export default CouplePackageThree;
