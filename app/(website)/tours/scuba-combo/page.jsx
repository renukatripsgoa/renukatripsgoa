...
// import TourCombo from "@/app/(website)/tour/scuba-combo/TourCombo"
...
const ScubaComboo = () => {
  ...
  const initialFxn = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/category?maincategory=${"Tour"}&subcategory=${"Scuba Combo"}`,
        {
          method: "GET",
          headers: {
  ...
  const imgSection = "/img/tour/scuba-combo/sport-imagee.jpg"
  ...
  return (
    <>
      <TourCombo data={data} title={"Scuba Combo"} titleImg={`/img/tour/scuba-combo/scuba-combo-home.jpg`} SLIDES={SLIDES} OPTIONS={OPTIONS} bookingSection={bookingSection} description={description} destination={destination} imgSection={imgSection} action={action} off={off} />
    </>
  );
};

export default ScubaComboo;
