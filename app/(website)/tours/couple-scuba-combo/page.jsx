...
const CoupleScubaComboo = () => {
  ...
  const SLIDES = [
    "/img/tour/couple-scuba-watersports/carousel/1.jpg",
    "/img/tour/couple-scuba-watersports/carousel/2.jpg",
    "/img/tour/couple-scuba-watersports/carousel/3.jpg",
    "/img/tour/couple-scuba-watersports/carousel/4.jpg",
    "/img/tour/couple-scuba-watersports/carousel/5.jpg",
  ]
  ...
  const initialFxn = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/category?maincategory=${"Tour"}&subcategory=${"Couple Scuba Water Sports"}`,
        {
          method: "GET",
          headers: {
  ...
  const imgSection = "/img/tour/couple-scuba-watersports/sport-image.jpg"
  ...
  return (
    <>
      <TourCombo data={data} title={"Couple Scuba Water Sports"} titleImg={`/img/tour/couple-scuba-watersports/couple-scuba-watersport.jpg`} SLIDES={SLIDES} OPTIONS={OPTIONS} bookingSection={bookingSection} description={description} destination={destination} imgSection={imgSection} action={action} off={off} />
    </>
  );
};

export default CoupleScubaComboo;
